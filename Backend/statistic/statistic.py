...
from statistic.crud import statistic_crud
from database.schemas import WaterBodyCompareRequest
...
@router.post("/compare")
def compare_water_bodies(request: WaterBodyCompareRequest, db: Session = Depends(get_db)):
